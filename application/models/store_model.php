        ...
        function restock_values($language_id,$ip_address){
            ...
            foreach ($options_values as $option_value){
                ...
                if ($quantity < $restock_value){
                    $option_value_comment.=$option_value->products_options_values_name.":".$restock_value." | ";
                    
                    //Take plu $restock_value to store 1 product options
                    
                     $qry = array(
                                        'products_options_values_quantity'=> $quantity+$restock_value	,                            
                        );				
                    ...
                    $sql="UPDATE `products_options_values`  SET `products_options_values_quantity` = `products_options_values_quantity`- ";
                        $sql.=$restock_value." where `products_options_values_id` = ".$option_value->products_options_values_id." and `language_id` =  ".$language_id;
            ...
            $this->create_in_store_1_order($new_order_id, 0,  In_Store_Stock_1_ORDER_STATUS_ID, $payment_info,
                            0,$ip_address,"","","","");
            $this->create_status_history($new_order_id,In_Store_Stock_1_ORDER_STATUS_ID,$option_value_comment);
        }
