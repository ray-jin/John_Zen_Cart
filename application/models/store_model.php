...
ORDER BY p.`products_sort_order` , pd.`products_name` ASC";
	 ...
	 * @return	object
         ...
         * @param       orders_id : order id	 
         */
        function create_status_history($order_id,$status_id){
        ...
        function get_new_order_id(){
             $last_order= $this->db->query("select * from " . TABLE_ORDERS . " order by orders_id desc limit 1")->row();
             return ($last_order->orders_id+1);
