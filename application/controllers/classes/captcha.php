...
class captcha {
  ...
  function captcha() {
    ...
    $this->captchaCode_length = 4;
    $this->img_width = 100;
    $this->img_height = 35;
    $this->img_type = 'png';
    $this->chars_shadow = true;
    $this->chars_min_size = 0.6;
    $this->chars_max_size = 0.8;
    $this->chars_rotation = 10;
    $this->noise = 10;
    $this->dir_fs_fonts = DIR_FS_CATALOG . 'fonts/';
    $this->max_try = 5;
    $this->failure_proc = '';
