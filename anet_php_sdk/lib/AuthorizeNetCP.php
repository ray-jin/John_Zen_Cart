...
class AuthorizeNetCP extends AuthorizeNetAIM
{
    ...
    const LIVE_URL = 'https://www.eProcessingNetwork.Com/cgi-bin/an/transact.pl';
    ...
    public function __construct($response, $delimiter, $encap_char, $custom_fields)
    {
        if ($response) {
            ...
            if (substr($response, 0, 5) == "<?xml") {
                ...
                $this->card_num             = isset($this->_response_array[20]) ? $this->_response_array[20] :"";
                $this->card_type            = isset($this->_response_array[21]) ? $this->_response_array[21] : "";
                $this->split_tender_id      = isset($this->_response_array[22]) ? $this->_response_array[22] : "";
                $this->requested_amount     = isset($this->_response_array[23]) ? $this->_response_array[23] : "";
                $this->approved_amount      = isset($this->_response_array[24]) ? $this->_response_array[24] : "";
                $this->card_balance         = isset($this->_response_array[25]) ? $this->_response_array[25] : "";
